...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={Transfer Learning for Image Segmentation},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Transfer Learning Segmentation}
\fancyhead[R]{Yassine Smaoui}
\fancyfoot[C]{\thepage}
...
% Définir HRule si pas déjà fait
...
\begin{titlepage}
    \begin{center}
        % Logo faculté
        \includegraphics[width=6cm]{logo_faculte.png} \\[1cm] % <-- Mets ton logo ici
